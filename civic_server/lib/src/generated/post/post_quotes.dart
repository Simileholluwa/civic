...
class PostQuotesUpdateTable extends _i1.UpdateTable<PostQuotesTable> {
  PostQuotesUpdateTable(super.table);
...
class PostQuotesTable extends _i1.Table<int?> {
  PostQuotesTable({super.tableRelation}) : super(tableName: 'post_quotes') {
    updateTable = PostQuotesUpdateTable(this);
  ...
  late final PostQuotesUpdateTable updateTable;
...
class PostQuotesRepository {
  ...
  /// Updates a single [PostQuotes] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<PostQuotes?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<PostQuotesUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<PostQuotes>(
      id,
      columnValues: columnValues(PostQuotes.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [PostQuotes]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<PostQuotes>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<PostQuotesUpdateTable> columnValues,
    ...
    return session.db.updateWhere<PostQuotes>(
      columnValues: columnValues(PostQuotes.t.updateTable),
