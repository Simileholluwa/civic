...
abstract class UserDevice
  ...
  static UserDeviceInclude include({_i2.UserRecordInclude? userInfo}) {
...
class UserDeviceTable extends _i1.Table<int?> {
  ...
  _i2.UserRecordTable? _userInfo;

  late final _i1.ColumnString token;

  _i2.UserRecordTable get userInfo {
...
class UserDeviceInclude extends _i1.IncludeObject {
  UserDeviceInclude._({_i2.UserRecordInclude? userInfo}) {
    _userInfo = userInfo;
  }

  _i2.UserRecordInclude? _userInfo;
...
class UserDeviceAttachRowRepository {
  ...
  /// Creates a relation between the given [UserDevice] and [UserRecord]
  /// by setting the [UserDevice]'s foreign key `userInfoId` to refer to the [UserRecord].
