...
-- Indexes
CREATE UNIQUE INDEX "post_parent_idx" ON "post" USING btree ("ownerId", "parentId");
CREATE UNIQUE INDEX "post_project_idx" ON "post" USING btree ("ownerId", "projectId");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('civic', '20250525073606732', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250525073606732', "timestamp" = now();
