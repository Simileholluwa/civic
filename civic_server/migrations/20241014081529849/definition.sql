...
CREATE TABLE "poll" (
    ...
    "tags" json NOT NULL,
    "pollDuration" timestamp without time zone
);

--
-- Class PollOption as table poll_options
--
...
--
-- Foreign relations for "poll_options" table
--
ALTER TABLE ONLY "poll_options"
    ADD CONSTRAINT "poll_options_fk_0"
    FOREIGN KEY("pollId")
    REFERENCES "poll"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('civic', '20241014081529849', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20241014081529849', "timestamp" = now();
