...
--
-- Class EngagementEvent as table engagement_event
--
...
--
-- Class ImpressionLog as table impression_log
--
...
CREATE TABLE "post" (
    ...
    "lastImpressionAt" timestamp without time zone
);
...
--
-- Class PostImpression as table post_impression
--
...
--
-- Class PostQuotes as table post_quotes
--
...
--
-- Class PostReposts as table post_reposts
--
...
CREATE TABLE "project" (
    ...
    "currency" text,
    "fundingCategory" text DEFAULT ''::text,
    "fundingSubCategory" text DEFAULT ''::text,
    "projectCost" double precision DEFAULT 0.0,
    "fundingNote" text DEFAULT ''::text,
    ...
    "quotesCount" bigint DEFAULT 0,
    "overallRating" double precision DEFAULT 0.0,
    "overallLocationRating" double precision DEFAULT 0.0,
    "overallDescriptionRating" double precision DEFAULT 0.0,
    "overallDatesRating" double precision DEFAULT 0.0,
    "overallAttachmentsRating" double precision DEFAULT 0.0,
    "overAllCategoryRating" double precision DEFAULT 0.0,
    "overallFundingRating" double precision DEFAULT 0.0,
    "isDeleted" boolean DEFAULT false,
    "lastImpressionAt" timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class ProjectRating as table project_rating
--
...
CREATE TABLE "project_review" (
    ...
    "locationRating" double precision DEFAULT 0.0,
    "descriptionRating" double precision DEFAULT 0.0,
    "attachmentsRating" double precision DEFAULT 0.0,
    "categoryRating" double precision DEFAULT 0.0,
    "fundingRating" double precision DEFAULT 0.0,
    "datesRating" double precision DEFAULT 0.0,
    "overallRating" double precision DEFAULT 0.0,
    "dateCreated" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone,
    "likesCount" bigint DEFAULT 0,
...
--
-- Foreign relations for "engagement_event" table
--
...
--
-- Foreign relations for "impression_log" table
--
...
--
-- Foreign relations for "post_impression" table
--
...
--
-- Foreign relations for "post_quotes" table
--
...
--
-- Foreign relations for "post_reposts" table
--
...
--
-- Foreign relations for "project_rating" table
--
