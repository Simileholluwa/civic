...
CREATE TABLE "project" (
    ...
    "pdfsCount" bigint DEFAULT 0,
    "attachmentsCount" bigint DEFAULT 0,
    "physicalLocationsCount" bigint DEFAULT 0,
    "virtualLocationsCount" bigint DEFAULT 0,
    "dateCreated" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone,
    "likesCount" bigint DEFAULT 0,
...
-- Indexes
CREATE INDEX "project_idx" ON "project" USING btree ("ownerId", "title", "dateCreated");

--
-- Class ProjectAttachment as table project_attachment
--
...
--
-- Class ProjectPhysicalLocation as table project_physical_location
--
...
--
-- Class ProjectVirtualLocation as table project_virtual_location
--
...
--
-- Foreign relations for "project_attachment" table
--
...
--
-- Foreign relations for "project_physical_location" table
--
...
--
-- Foreign relations for "project_virtual_location" table
--
