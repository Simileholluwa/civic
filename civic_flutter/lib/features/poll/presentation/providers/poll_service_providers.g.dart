...
part of 'poll_service_providers.dart';
...
final pollRemoteDatasourceProvider =
    AutoDisposeProvider<PollRemoteDatasourceImpl>.internal(
  pollRemoteDatasource,
  name: r'pollRemoteDatasourceProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$pollRemoteDatasourceHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final pollRepositoryImplProvider =
    AutoDisposeProvider<PollRepositoryImpl>.internal(
  pollRepositoryImpl,
  name: r'pollRepositoryImplProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$pollRepositoryImplHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final schedulePollProvider = AutoDisposeProvider<SchedulePollUseCase>.internal(
  schedulePoll,
  name: r'schedulePollProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$schedulePollHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
/// See also [getPoll].
@ProviderFor(getPoll)
final getPollProvider = AutoDisposeProvider<GetPollUseCase>.internal(
  getPoll,
  name: r'getPollProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$getPollHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
