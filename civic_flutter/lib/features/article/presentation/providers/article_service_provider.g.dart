...
part of 'article_service_provider.dart';
...
final articleRemoteDatasourceProvider =
    AutoDisposeProvider<ArticleRemoteDatasourceImpl>.internal(
...
final articleRepositoryProvider =
    AutoDisposeProvider<ArticleRepositoryImpl>.internal(
  articleRepository,
...
final deleteArticleProvider =
    AutoDisposeProvider<DeleteArticleUseCase>.internal(
  deleteArticle,
  name: r'deleteArticleProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$deleteArticleHash,
  dependencies: null,
...
final getArticleProvider = AutoDisposeProvider<GetArticleUseCase>.internal(
  getArticle,
  name: r'getArticleProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$getArticleHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
