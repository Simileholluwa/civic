...
class ReactToProjectReviewUseCase implements UseCase<ProjectReview, ReactToProjectReviewParams> {
  ReactToProjectReviewUseCase({required ProjectRepository projectRepository})
      : _projectRepository = projectRepository;
  final ProjectRepository _projectRepository;

  @override
  Future<Either<Failure, ProjectReview>> call(ReactToProjectReviewParams params) async {
