...
class MarkPostNotInterested extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final postCardNotifier = ref.watch(postCardWidgetProvider(post).notifier);
    final postCardState = ref.watch(postCardWidgetProvider(post));
    return Scaffold(
