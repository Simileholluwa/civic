...
import 'post/post_notif_sun.dart' as _i19;
...
import 'project/project_notif_sub.dart' as _i27;
...
import 'project/project_list.dart' as _i37;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i19.PostSubscription) {
      return _i19.PostSubscription.fromJson(data) as T;
    }
    if (t == _i20.PostType) {
    ...
    if (t == _i27.ProjectSubscription) {
      return _i27.ProjectSubscription.fromJson(data) as T;
    }
    ...
    if (t == _i37.ProjectList) {
      return _i37.ProjectList.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i19.PostSubscription?>()) {
      return (data != null ? _i19.PostSubscription.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i27.ProjectSubscription?>()) {
      return (data != null ? _i27.ProjectSubscription.fromJson(data) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i37.ProjectList?>()) {
      return (data != null ? _i37.ProjectList.fromJson(data) : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i19.PostSubscription) {
    ...
    if (data is _i27.ProjectSubscription) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'PostSubscription') {
      return deserialize<_i19.PostSubscription>(data['data']);
    }
    ...
    if (dataClassName == 'ProjectSubscription') {
      return deserialize<_i27.ProjectSubscription>(data['data']);
    }
    ...
    if (dataClassName == 'ProjectList') {
      return deserialize<_i37.ProjectList>(data['data']);
    }
