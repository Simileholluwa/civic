...
import 'article/article_list.dart' as _i3;
...
import 'package:civic_client/src/protocol/general/aws_places.dart' as _i27;
import 'package:civic_client/src/protocol/user/user_record.dart' as _i28;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i3.ArticleList) {
      return _i3.ArticleList.fromJson(data) as T;
    }
    if (t == _i4.AWSPlaces) {
    ...
    if (t == _i1.getType<_i3.ArticleList?>()) {
      return (data != null ? _i3.ArticleList.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i26.Article>) {
      return (data as List).map((e) => deserialize<_i26.Article>(e)).toList()
          as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ArticleList') {
      return deserialize<_i3.ArticleList>(data['data']);
    }
