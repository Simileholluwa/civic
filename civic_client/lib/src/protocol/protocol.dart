...
import 'post/post_reposts.dart' as _i23;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i23.PostReposts) {
      return _i23.PostReposts.fromJson(data) as T;
    }
    if (t == _i24.PostType) {
    ...
    if (t == _i1.getType<_i23.PostReposts?>()) {
      return (data != null ? _i23.PostReposts.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'PostReposts') {
      return deserialize<_i23.PostReposts>(data['data']);
    }
